...
class Weather(commands.Cog):
    ...
    async def weather_unsubscribe(self, inter: discord.Interaction, subscription_id: int):
        ...
        await inter.followup.send(f"Deleted weather announcement subscription {subscription_id}." if ok else "Could not delete subscription {subscription_id}.", ephemeral=True)
